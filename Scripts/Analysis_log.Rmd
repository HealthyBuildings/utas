...
library(Hmisc)
library(readr)
wdir <- read_csv("~/Piers's Homework/Harvard/Work/Doctoral/UTC/UTAS/Data/Analysis/Github/utas/wdir.csv", col_names = FALSE)
setwd(wdir$X1[1])
ManeuverLevel<-read_csv("Data/ManeuverLevel.csv")
...
wdir <- read_csv("~/Piers's Homework/Harvard/Work/Doctoral/UTC/UTAS/Data/Analysis/Github/utas/wdir.csv", col_names = FALSE)
setwd(wdir$X1[1])
SimulatorProc<-read_csv("Data/SimulatorProc.csv")
